                        ...
                        <div class="bg-white">
                            <div class="bg-light px-4 py-2">
                                ...
                                <div class="col-12">
                                    ...
                                    $msg_rs = Database::search("SELECT DISTINCT `message`,`date_time`,`status`,`from` 
                                    FROM `message` WHERE `to`='" . $mail . "' ORDER BY `date_time` DESC");
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-white rounded-0 bg-primary">
                                                                <div class="media">
                                                                    ...
                                                                    if (isset($img_data["code"])) {
                                                                    ?>
                                                                        <img src="<?php echo $img_data["code"]; ?>" width="50px" class="rounded-circle" />
                                                                    <?php
                                                                    } else {
                                                                    ?>
                                                                        <img src="resource/profile_img/Dilmith_640d6aa04507d.jpeg" width="50px" class="rounded-circle">
                                                                    <?php
                                                                    }
                                                        ...
                                                        <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-dark rounded-0 bg-body">
                                                                <div class="media">
                                                                    ...
                                                                    ?>
                                                                        <img src="resource/logo.png" width="50px" class="rounded-circle">
                                                                    <?php
                                                                    }
                                        ...
                                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            ...
                                            $msg_rs2 = Database::search("SELECT DISTINCT `message`,`date_time`,`status`,`to` 
                                    FROM `message` WHERE `from`='" . $mail . "' ORDER BY `date_time` DESC");
                                                    ...
                                                    <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                        <a href="#" class="list-group-item list-group-item-action text-black rounded-0 bg-secondary">
                                                            <div class="media">
                                                                ...
                                                                if (isset($img_data2["code"])) {
                                                                ?>
                                                                    <img src="<?php echo $img_data2["code"]; ?>" width="50px" class="rounded-circle" />
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    <img src="resource/logo.png" width="50px" class="rounded-circle">
