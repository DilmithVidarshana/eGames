        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase mt-4 text-warning">eGames</h5>
                    <p>Here we are the eGames.lk&trade;</p>
                </div>

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <p>Copyright &copy; 2022 eGames All Rights Reserved</p>
                </div>
                ...
                <p><i class="bi bi-at"></i> eGames@gmail.com</p>
